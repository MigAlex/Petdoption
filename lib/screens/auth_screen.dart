          ...
          Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  Color.fromRGBO(0, 117, 155, 0).withOpacity(0.76),
                  Color.fromRGBO(200, 88, 110, 100).withOpacity(0.9),
                ],
...
class _AuthCardState extends State<AuthCard> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      var errorMessage = 'Authentication has failed';
      if (error.toString().contains('EMAIL_EXISTS')) {
        errorMessage = 'This email address is already taken!';
      } else if (error.toString().contains('INVALID_EMAIL')) {
        errorMessage = 'This is not a valid email';
      } else if (error.toString().contains('WEAK_PASSWORD')) {
        errorMessage = 'This password is too weak or too short';
      ...
      const errorMessage =
          'Unable to authenticate you. Please try again later.';
      _showErrorDialog(errorMessage);
    }
